import { IQUERYChoose } from "@Interfaces/IQUERYChoose";

export const QUERYChoose: IQUERYChoose = {
  errors: "",
  queries: "usd",
  currency: "usd",
  category: "layer-1",
  ...
  scheme: {
    ...
    request:
      "https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&category=layer-1&per_page=10&page=1",
  },
};
